"""
Точка входа UI на Gradio. Запускает ASR и LLM-воркеры subprocess'ами, собирает интерфейс из трёх вкладок: транскрипция, база знаний, чат. Вешает все события и таймеры поллинга.
"""
